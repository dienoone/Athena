...
namespace Athena.Migrators.Migrations
{
    ...
    [Migration("20230131180241_AddTeacherStudnetTabels")]
    partial class AddTeacherStudnetTabels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Athena.Domain.Entities.GroupStudent", b =>
                {
                    ...
                    b.Property<Guid>("TeacherCourseLevelStudentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TeacherCourseLevelStudentId");
            ...
            modelBuilder.Entity("Athena.Domain.Entities.TeacherCourseLevelStudent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TeacherCourseLevelStudents", "Catalog");
                });
            ...
            modelBuilder.Entity("Athena.Domain.Entities.GroupStudent", b =>
                {
                    ...
                    b.HasOne("Athena.Domain.Entities.TeacherCourseLevelStudent", "TeacherCourseLevelStudent")
                        .WithMany("GroupStudents")
                        .HasForeignKey("TeacherCourseLevelStudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Group");

                    b.Navigation("TeacherCourseLevelStudent");
                });
            ...
            modelBuilder.Entity("Athena.Domain.Entities.TeacherCourseLevelStudent", b =>
                {
                    b.HasOne("Athena.Domain.Entities.Student", "Student")
                        .WithMany("TeacherCourseLevelStudents")
            ...
            modelBuilder.Entity("Athena.Domain.Entities.Student", b =>
                {
                    b.Navigation("TeacherCourseLevelStudents");
                });
