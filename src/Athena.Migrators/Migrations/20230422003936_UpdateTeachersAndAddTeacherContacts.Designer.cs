...
namespace Athena.Migrators.Migrations
{
    ...
    [Migration("20230422003936_UpdateTeachersAndAddTeacherContacts")]
    partial class UpdateTeachersAndAddTeacherContacts
    {
            ...
            modelBuilder.Entity("Athena.Domain.Entities.Exam", b =>
                {
                    ...
                    b.Property<Guid>("TeacherCourseLevelYearSemsterId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TeacherCourseLevelYearSemsterId");
            ...
            modelBuilder.Entity("Athena.Domain.Entities.Exam", b =>
                {
                    ...
                    b.HasOne("Athena.Domain.Entities.TeacherCourseLevelYearSemster", "TeacherCourseLevelYearSemster")
                        .WithMany("Exams")
                        .HasForeignKey("TeacherCourseLevelYearSemsterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ExamType");

                    b.Navigation("TeacherCourseLevelYearSemster");
                });
