...
{
    /* public class UsersController : VersionNeutralApiAuthGroupController
     {
         ...
         [HttpGet]
         [MustHavePermission(AAction.View, AResource.Users)]
         ...
         [HttpGet("{id}/roles")]
         [MustHavePermission(AAction.View, AResource.UserRoles)]
         ...
         [HttpPost("{id}/roles")]
         [ApiConventionMethod(typeof(AthenaApiConventions), nameof(AthenaApiConventions.Register))]
         [MustHavePermission(AAction.Update, AResource.UserRoles)]
         ...
         [HttpPost]
         [MustHavePermission(AAction.Create, AResource.Users)]
         ...
         public Task<string> CreateAsync(CreateUserRequest request)
         {
             ...
             return _userService.CreateAsync(request, GetOriginFromRequest(), ARoles.Teacher, null);
         }
         ...
         [MustHavePermission(AAction.Update, AResource.Users)]
         [ApiConventionMethod(typeof(AthenaApiConventions), nameof(AthenaApiConventions.Register))]
         ...
         [ApiConventionMethod(typeof(AthenaApiConventions), nameof(AthenaApiConventions.Search))]
